...
pub fn catalog() -> &'static [PaletteAction] {
    &[
        ...
        PaletteAction { command: "add_cursor_next_match", title: "Add Cursor: Next Match", hint: "Ctrl+D" },
        PaletteAction { command: "select_all_matches", title: "Select All Matches", hint: "Ctrl+L" },
        ...
        PaletteAction { command: "select_line", title: "Select Line", hint: "" },
        ...
        PaletteAction { command: "close_buffer", title: "Close Buffer", hint: "" },
